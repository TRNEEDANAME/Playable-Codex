...
static function X2DataTemplate CreateTeleportAbility()
{
	...
	CursorTarget = new class'X2AbilityTarget_Cursor';
	CursorTarget.bRestrictToSquadsightRange = default.PACodex_TP_RestrictToSquadsightRange;
	CursorTarget.FixedAbilityRange = default.PACodex_TP_Range;
	Template.AbilityTargetStyle = CursorTarget;
...
static function X2AbilityTemplate CreatePA_PsiBombStage1Ability()
{
	local X2AbilityTemplate Template;
	local X2AbilityCost_ActionPoints ActionPointCost;
	local X2AbilityCooldown_LocalAndGlobal Cooldown;
	...
	`CREATE_X2ABILITY_TEMPLATE(Template, 'PA_PsiBombStage1');

	Template.AdditionalAbilities.AddItem('PA_PsiBombStage2');
	Template.TwoTurnAttackAbility = 'PA_PsiBombStage2';
	...
	Template.BuildVisualizationFn = PA_PsiBombStage1_BuildVisualization;
	Template.BuildAffectedVisualizationSyncFn = PA_PsiBombStage1_BuildAffectedVisualization;
	Template.CinescriptCameraType = "Codex_PsiBomb_Stage1";
	Template.DamagePreviewFn = PsiBombDamagePreview;
//BEGIN AUTOGENERATED CODE: Template Overrides 'PA_PsiBombStage1'
	Template.bFrameEvenWhenUnitIsHidden = true;
//END AUTOGENERATED CODE: Template Overrides 'PA_PsiBombStage1'
...
function bool PsiBombDamagePreview(XComGameState_Ability AbilityState, StateObjectReference TargetRef, out WeaponDamageValue MinDamagePreview, out WeaponDamageValue MaxDamagePreview, out int AllowsShield)
{
	...
	{
		`RedScreenOnce("Unit has PA_PsiBombStage1 but is missing PA_PsiBombStage2. No es Bueno. -dslonneger @gameplay");
	}
	else
	{
...
simulated function PA_PsiBombStage1_BuildVisualization(XComGameState VisualizeGameState)
{
	local XComGameStateHistory History;
...
simulated function PA_PsiBombStage1_BuildAffectedVisualization(name EffectName, XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata )
{
	local XComGameStateContext_Ability Context;
	local X2Action_PlayEffect EffectAction;
	local X2Action_StartStopSound SoundAction;
...
static function X2AbilityTemplate CreatePA_PsiBombStage2Ability()
{
	local X2AbilityTemplate Template;
	local X2AbilityMultiTarget_Radius RadiusMultiTarget;
	...
	`CREATE_X2ABILITY_TEMPLATE(Template, 'PA_PsiBombStage2');
...
//BEGIN AUTOGENERATED CODE: Template Overrides 'PA_PsiBombStage2'
	Template.bFrameEvenWhenUnitIsHidden = true;
//END AUTOGENERATED CODE: Template Overrides 'PA_PsiBombStage2'

	return Template;
}

simulated function PA_PsiBombStage2_BuildVisualization(XComGameState VisualizeGameState)
{
	local XComGameStateHistory History;
	local XComGameStateContext_Ability  Context;
	local StateObjectReference InteractingUnitRef;
